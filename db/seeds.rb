...
User.create(name: "E.J.", email: "student1@nku.edu", password: "password", password_confirmation: "password").enrolled_courses << se << os << ai
User.create(name: "Andy", email: "student2@nku.edu", password: "password", password_confirmation: "password").enrolled_courses << se << os << tc << wp
User.create(name: "Matt", email: "student3@nku.edu", password: "password", password_confirmation: "password").enrolled_courses << se << ai << tc
User.create(name: "Mike", email: "student4@nku.edu", password: "password", password_confirmation: "password").enrolled_courses << se << ai

User.create(name: "Tim McCord", email: "faculty1@nku.edu", password: "password", password_confirmation: "password").taught_courses << se
User.create(name: "Gary Newell", email: "faculty2@nku.edu", password: "password", password_confirmation: "password").taught_courses << os << tc
User.create(name: "Richard Fox", email: "faculty3@nku.edu", password: "password", password_confirmation: "password").taught_courses << ai
User.create(name: "Jesse Hockenburry", email: "faculty4@nku.edu", password: "password", password_confirmation: "password").taught_courses << wp
